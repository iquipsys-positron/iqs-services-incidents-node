...
export interface IIncidentsController {
    ...
    getIncidentById(correlationId: string, incident_id: string, callback: (err: any, incident: IncidentV1) => void): void;
    createIncident(correlationId: string, incident: IncidentV1, callback: (err: any, incident: IncidentV1) => void): void;
    closeIncident(correlationId: string, incident_id: string, user: any, resolutionId: string, resolution: string, callback: (err: any, incident: IncidentV1) => void): void;
    deleteIncidentById(correlationId: string, incident_id: string, callback: (err: any, incident: IncidentV1) => void): void;
